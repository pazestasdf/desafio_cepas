...
ActiveRecord::Schema.define(version: 2021_09_01_210823) do
  ...
  create_table "oenologist_scores", force: :cascade do |t|
    t.integer "wine_id"
    t.integer "oenologist_id"
    t.integer "score", limit: 100
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["oenologist_id"], name: "index_oenologist_scores_on_oenologist_id"
    t.index ["wine_id"], name: "index_oenologist_scores_on_wine_id"
  end
  ...
  create_table "oenologists_wines_scores", force: :cascade do |t|
    t.integer "oenologists_wines_id"
    t.integer "score", limit: 100
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["oenologists_wines_id"], name: "index_oenologists_wines_scores_on_oenologists_wines_id"
  end
